...
def compile_metrics(results_path: Path, 
                        save_path: Path): 
    '''
    Calculate performance metrics of all generated segmentations from MedSAM2-RECIST model. Results must
    ...
    for file in results_path.iterdir(): 
        ...
        curr_metric_df['filename'] = str(file)
...
if __name__ == '__main__': 
    ...
    compile_metrics(results_path = seg_path, 
                    save_path = save_path)
